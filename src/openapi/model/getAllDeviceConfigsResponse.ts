 ...
 */
import type { GetAllDeviceConfigsResponseKey } from './getAllDeviceConfigsResponseKey';

export interface GetAllDeviceConfigsResponse {
  id?: string;
  /** 장치 설정 키
- DK001: URL
 */
  key?: GetAllDeviceConfigsResponseKey;
  value?: string;
}
